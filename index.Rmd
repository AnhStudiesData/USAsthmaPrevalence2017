...
link-citations: yes
github-repo: AnhStudiesData/USAsthmaPrevalence2017
url: 'https\://anhstudiesdata.github.io/USAsthmaPrevalence2017/'
---
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'tidyverse', 'scales', 'viridis', 'cowplot', 'gridExtra', 'grid', 'usmap'
), 'packages.bib')
```
