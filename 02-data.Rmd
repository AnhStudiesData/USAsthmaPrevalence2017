...
Since the original dataset was large, the author set 'eval=FALSE' for this section. The cleaned dataset used for analysis will be found in the next section.
